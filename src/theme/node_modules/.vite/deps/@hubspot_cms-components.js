...
import {
  ...
  getConfigSingleton
} from "./chunk-M4IFJGCI.js";
import {
  __toESM
} from "./chunk-5WRI5ZAA.js";

// node_modules/@hubspot/cms-components/dist/index.js
...
async function wrapServerCodeWithRenderContext(contextValue, callback) {
  ...
  if (!AsyncStorageForServerContext) {
    const { AsyncLocalStorage } = await import("./async_hooks-BDK3IDCS.js");
...
var ServerRenderContext = (0, import_react2.createContext)(
...
var useServerRenderContext = () => {
  ...
  return (0, import_react2.useContext)(ServerRenderContext);
};
...
var ClientRenderContext = (0, import_react2.createContext)(
...
var ClientRenderContextProvider = ({
  ...
  const hydrationFinished = (0, import_react2.useRef)(false);
  const contextValue = {
    pageUrl,
    islands,
    hydrationFinished,
  ...
  return (0, import_jsx_runtime.jsx)(ClientRenderContext.Provider, { value: contextValue, children });
};
var useClientRenderContext = () => (0, import_react2.useContext)(ClientRenderContext);
var useRenderContext = () => {
  if (import.meta.env.SSR) {
    return (0, import_react2.useContext)(ServerRenderContext);
  }
  return (0, import_react2.useContext)(ClientRenderContext);
};
...
var ExistingIslandContext = (0, import_react3.createContext)(null);
var ExistingIslandContextProvider = ExistingIslandContext.Provider;
function useIsInsideIsland() {
  return (0, import_react3.useContext)(ExistingIslandContext) != null;
}
var SharedIslandStateContext = (0, import_react4.createContext)({
  id: UNSET_SHARED_STATE_ID,
  state: null
});
function useSharedIslandStateID() {
  return (0, import_react4.useContext)(SharedIslandStateContext).id;
}
...
function SharedIslandReducer({
  ...
  const sharedStateID = id2 ?? `hs-ss-${(0, import_react4.useId)()}`;
  const renderContext = useServerRenderContext();
...
function useGetStateSnapshotFunc(id2) {
  return (0, import_react4.useMemo)(() => () => getLatestSharedStateFor(id2), [id2]);
}
function useGetInitialStateSnapshotFunc(id2) {
  return (0, import_react4.useMemo)(() => () => getInitialSharedStateFor(id2), [id2]);
}
...
function useSharedIslandReducerServerHelper() {
  const { state, id: id2 } = (0, import_react4.useContext)(SharedIslandStateContext);
  let updaterFunc;
...
function useSharedIslandReducerClientHelper(customReducerFunc) {
  ...
  const claimedRef = (0, import_react4.useRef)();
  let origReducerFunc;
  ...
  if (!hasReducerBeenClaimedYet || claimedRef.current === sharedStateID) {
    ...
    const reducerFunc = (0, import_react4.useCallback)(
      (state, action) => {
    ...
    const [currentState, dispatch] = (0, import_react4.useReducer)(reducerFunc, value);
    if (!dispatchById.has(sharedStateID)) {
      dispatchById.set(sharedStateID, dispatch);
    }
    return [currentState, dispatch, sharedStateID];
  } else {
    const currentState = (0, import_react4.useSyncExternalStore)(
...
async function load() {
  if (import.meta.env && !import.meta.env.SSR) {
    ...
    const result = await import("./RenderTreeSeparately-T6CL43QJ-TO3PK3OB.js");
    return result;
  }
}
...
function RenderIslandSeparately({
  ...
  const renderContext = useServerRenderContext();
  const sharedIslandState = (0, import_react5.useContext)(SharedIslandStateContext);
  const LazyComponent = (0, import_react5.lazy)(lazyModule);
  const RenderTreeSeparately = (0, import_react5.lazy)(async () => ({
    default: (await load()).RenderTreeSeparately
  }));
  const uniqueRenderID = { id: `${renderContext.renderId}-${id2}` };
  let innerTreeElements = (0, import_jsx_runtime3.jsx)(LazyComponent, { islandId: id2, ...componentProps });
  if (sharedIslandState.id !== UNSET_SHARED_STATE_ID) {
    innerTreeElements = (0, import_jsx_runtime3.jsx)(SharedIslandStateContext.Provider, { value: sharedIslandState, children: innerTreeElements });
  }
  if (Wrapper) {
    const LazyWrapper = (0, import_react5.lazy)(Wrapper);
    innerTreeElements = (0, import_jsx_runtime3.jsx)(LazyWrapper, { children: innerTreeElements });
  }
  innerTreeElements = (0, import_jsx_runtime3.jsx)(
    import_react5.Suspense,
    {
      fallback: `server render fail/waiting for ${id2} (separate island render, inside)`,
      children: (0, import_jsx_runtime3.jsx)(ServerRenderContext.Provider, { value: renderContext, children: (0, import_jsx_runtime3.jsx)(ExistingIslandContextProvider, { value: lazyModule.moduleId, children: innerTreeElements }) })
    }
  );
...
function Island({
  ...
  const instanceId = buildIslandID((0, import_react.useId)());
  ...
  const LazyComponent = (0, import_react.lazy)(module);
  return (0, import_jsx_runtime4.jsx)(ExistingIslandContextProvider, { value: module.moduleId, children: (0, import_jsx_runtime4.jsx)(
    WrapperElement,
    {
      "data-hs-island": true,
      id: resolvedId,
      style: wrapperStyle,
      className: wrapperClassName,
      children: (0, import_jsx_runtime4.jsx)(import_react.Suspense, { fallback: `server render fail/waiting for ${resolvedId}`, children: (0, import_jsx_runtime4.jsx)(LazyComponent, { islandId: resolvedId, ...moduleProps }) })
    }
  ) });
}
...
var useIsServerOrFirstClientRender = () => {
  ...
  const [hasRenderedOnClient, setHasRenderedOnClient] = (0, import_react6.useState)(false);
  if (isServerRender) {
    return true;
...
var useIsAfterMountWithoutForcingRerender = () => {
  const afterMountRef = (0, import_react6.useRef)(false);
  (0, import_react6.useEffect)(() => {
...
var useCurrentClientPageURL = (originalUrl, componentId) => {
  ...
  const [currentURL, setCurrentURL] = (0, import_react7.useState)(
...
var usePageUrl = () => {
  const componentId = `${(0, import_react7.useId)()}pageUrl`;
...
var ISO639CodeEnum = ((ISO639CodeEnum2) => {
...
function Icon(props) {
  ...
  const instanceId = (0, import_react8.useId)();
  ...
  return (0, import_jsx_runtime7.jsxs)(
    "svg",
    {
      ...
      ...rest,
      children: [
        purpose === "SEMANTIC" && title && (0, import_jsx_runtime7.jsx)("title", { id: uniqueId, children: title }),
        (0, import_jsx_runtime7.jsx)("path", { d: svgPathTemplate })
      ]
    }
  );
}
...
//# sourceMappingURL=@hubspot_cms-components.js.map
